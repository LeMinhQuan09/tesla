<?php
/**
 * Template Name: Template Learning
 */
...
<main>
	...
	<div class="container mt-100 mb-200 mt-30-mob mb-0-mob">
	...
	<?php if( have_rows('content_section_6') ): ?>
	    <?php while( have_rows('content_section_6') ): the_row(); 
	        $image = get_sub_field('image');
	        $select = get_sub_field('select');
	        $title = get_sub_field('title');
	        $id = get_sub_field('id');
