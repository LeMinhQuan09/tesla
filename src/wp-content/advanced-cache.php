...
$nitropack_functions_file = '/home/tesla/domains/tesla.edu.vn/public_html/wp-content/plugins/nitropack/functions.php';
$nitropack_abspath = '/home/tesla/domains/tesla.edu.vn/public_html/';
...
if (file_exists($nitropack_functions_file) && ABSPATH == $nitropack_abspath) {
    ...
    define( 'NITROPACK_ADVANCED_CACHE_VERSION', '1.17.0');
    define( 'NITROPACK_LOGGED_IN_COOKIE', 'wordpress_logged_in_919cac6d96c76bde25ceaaae4f8fca9e' );
